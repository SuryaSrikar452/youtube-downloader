 ...
 * Supports environment cookies, mobile user-agents, and client fallback chains to bypass bot checks.
 */
async function downloadStream(videoId, format, res) {
  ...
  console.log(`[ytEngine] Starting download for videoId: ${videoId}, format: ${format} (cookies=${!!cookiesPath})`);
